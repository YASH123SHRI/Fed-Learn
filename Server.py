#A custom FederatedDPStrategy was implemented by extending Flower's FedAvg, enabling aggregation only from clients with balanced class distributions. Differential Privacy was enforced with an ε function from client-side mechanisms, and evaluation metrics included accuracy, precision, recall, and F1-score.
